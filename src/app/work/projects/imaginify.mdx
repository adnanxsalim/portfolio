...
In this project, I implemented an full-stack AI image manipulation tool, with the help of this [tutorial](https://youtu.be/Ahwoks_dawU) from [JavaScript Mastery](https://www.youtube.com/@javascriptmastery).
