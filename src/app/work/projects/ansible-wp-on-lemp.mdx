...
- **SFTP**: For others(say, a developer) to access/edit the contents via a secure SFTP port.
- **phpMyAdmin**: As additional security and as a GUI for the MySQL database.
